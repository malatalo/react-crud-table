...
export default class CustomTableRow extends Component {
  ...
  enableEdit = () => {
    this.setState(prevState => ({person: {...prevState.person, edit: true},
  ...
  cancelSave = () => {
    this.setState(prevState => ({person:{...prevState.person, edit: false}}));
  }
  ...
  render() {
    return (
      <TableRow key={this.state.person.id}>
        <TableCell>{this.state.person.edit ?
